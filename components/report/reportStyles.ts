...
export const REPORT_CARD_CLASS =
  "rounded-[28px] border border-[var(--stroke-light)] bg-white px-5 py-6 transition-all hover:-translate-y-[1px] hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] md:px-8";

export const REPORT_CARD_CLASS_ANIMATED =
  "rounded-[28px] border border-[var(--stroke-light)] bg-white px-5 py-6 transition-all duration-200 hover:-translate-y-[1px] hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] md:px-8";

export const REPORT_ITEM_TITLE_CLASS =
  "text-[20px] font-medium leading-[1.45] tracking-[-0.02em] text-[var(--ink-primary)] md:max-w-[75%] md:text-[22px] md:leading-[1.5]";
