          ...
          <div className="grid grid-cols-1 gap-px md:grid-cols-3">
            ...
            <Cell>
              ...
              <div className="mt-[18px] flex items-center gap-2">
                <span className="font-sans text-[22px] font-bold tracking-[-0.04em] text-[#BA7517]">6.8</span>
                <span className="text-[#7A7A74]">→</span>
                <span className="font-sans text-[22px] font-bold tracking-[-0.04em] text-[#1D9E75]">8.5</span>
