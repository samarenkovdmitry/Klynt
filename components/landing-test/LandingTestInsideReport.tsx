  ...
  return (
    <section className={`${UPDATE_SECTION} bg-[#F5F7FA]`}>
      <div className={LANDING_UPDATE_CONTAINER}>
        ...
        <div
          className={`${UPDATE_SECTION_GRID} overflow-hidden rounded-[28px] border border-[rgba(6,28,47,0.06)] bg-white shadow-[0_16px_48px_rgba(6,28,47,0.06)]`}
        >
          {INSIDE_REPORT_ITEMS.map((item, index) => (
            ...
            >
                  ...
                  <div className="min-w-0">
                    ...
                    {item.showSkeleton ? (
                      <div className="mt-4 space-y-2">
                        <div className="h-2 w-full max-w-[320px] rounded-full bg-[#E5E7EB]" />
                        <div className="h-2 w-full max-w-[240px] rounded-full bg-[#E5E7EB]" />
                      </div>
                    ) : null}
                    {item.footer ? (
              ...
              {item.showComparison ? (
                <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5 md:pl-[68px]">
                  ...
                  <div className="rounded-[20px] border border-sky-200 bg-sky-50/70 p-5">
                    ...
                    <div className="mt-3 space-y-2">
                      <div className="h-2 w-full rounded-full bg-[#2563EB]" />
                      <div className="h-2 w-[70%] rounded-full bg-[#2563EB]/70" />
                    </div>
