...
export const LANDING_EYEBROW = "text-[13px] font-medium text-white/40 md:text-[14px]";

export const LANDING_TITLE =
  "mt-3 max-w-[520px] text-[26px] font-semibold leading-[1.15] tracking-[-0.02em] text-white md:text-[30px]";
